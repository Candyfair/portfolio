      ...
      <div className="wrapper">
        <div className="timeline-area">
          ...
          <div className="single-item">
            <span>2004</span>
            <div className="image-area">
              <p>I'm a management accountant for an American consulting firm where I'm known as "The Queen of Excel". My dashboards include pivot tables and are automated with sparkling <em className="tint3">VBA</em> scripts.</p>
            </div>
          </div>
          ...
          <div className="single-item">
            <span>2008</span>
            <div className="image-area">
              <p>I move to the South of France and start an online business. I begin with the open source platform Joomla and the extension Virtuemart for <em className="tint4">e-commerce</em>. Two years later my business expands and I migrate to Prestashop. For both of these I learn to use PHP to make my site stand out.</p>
            </div>
          </div>
          ...
          <div className="single-item">
            <span>2015</span>
            <div className="image-area">
              <p>My life takes an unexpected turn. I have to close my business and move back to Paris. I take an administrative job which involves managing some IT projects and in my free time I learn <em className="tint1">JavaScript</em>.</p>
            </div>
          </div>
          ...
          <div className="single-item">
            <span>2021</span>
            <div className="image-area">
              <p>I decide that I need to do a dedicated Full Stack training to bring together everything that I've learnt over the years. My passion for <em className="tint3">UI and graphic design</em> push me towards front end development.</p>
